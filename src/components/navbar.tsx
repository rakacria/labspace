...
import { FlaskConical, LogOut, BookOpen, User, Trophy, Compass } from "lucide-react"
    ...
    <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b-[0.5px] border-black/5 shadow-[0_2px_10px_rgb(0,0,0,0.02)]">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link
            href="/discover"
            className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold text-slate-500 hover:text-slate-900 hover:bg-slate-100/80 transition-colors"
          >
            ...
            <>
              <Link
                ...
                className={cn(
                  ...
                  "rounded-full hidden sm:flex font-semibold gap-1.5 border-slate-200"
                )}
              >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="relative h-10 w-10 rounded-full cursor-pointer focus:outline-none ring-2 ring-transparent focus:ring-primary/20 transition-all shadow-sm">
